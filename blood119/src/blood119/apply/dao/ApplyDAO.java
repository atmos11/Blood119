...
public class ApplyDAO {
	...
	public void insertApply(ApplyVO vo) {
		String sql = "insert into apply(apply_sort, apply_id, apply_date, location, "
				+ "ani_name, ani_type, ani_bloodtype, ani_gender, ani_age) values(?,?,?,?,?,?,?,?,?)";
		...
		try {
			...
			pstmt.setString(2, vo.getApply_id());
			pstmt.setDate(3, vo.getApply_date());
